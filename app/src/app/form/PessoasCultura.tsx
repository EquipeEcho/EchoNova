...
export const perguntasPC: Pergunta[] = [
    {
        ...
        opcoes: [
            ...
            { valor: "p1-1", texto: "Todos têm clareza e acesso fácil às informações." },
            { valor: "p1-2", texto: "Funciona na maior parte do tempo, mas com algumas falhas." },
            { valor: "p1-3", texto: "Normalmente só em reuniões formais ou quando há problemas." },
    ...
    },
    {
        ...
        opcoes: [
            ...
            { valor: "p4-2", texto: "Há certa clareza, mas faltam recursos ou prazos realistas." },
            { valor: "p4-3", texto: "Muitas vezes é confusa, com foco em “apagar incêndios”." },
            { valor: "p4-4", texto: "Não há organização definida, cada um faz do seu jeito." }
        ],
        required: true
    },
    {
    ...
    },
    {
        ...
        opcoes: [
            { valor: "", texto: "Selecione a opção" },
            { valor: "p6-1", texto: "Temos plataforma estruturada de desenvolvimento." },
            { valor: "p6-2", texto: "Algumas iniciativas digitais, mas sem consistência." },
            { valor: "p6-3", texto: "Recursos informais (planilhas, grupos de mensagens)." },
