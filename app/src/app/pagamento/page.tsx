                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.nome ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.email ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.telefone ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.cpf ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.nomeEmpresa ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.cnpj ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.endereco ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.cidade ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="Cidade"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.estado ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="SP"
                        maxLength={2}
                      />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.cep ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.numeroCartao ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.nomeCartao ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.validadeCartao ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="MM/AA"
                        maxLength={5}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.cvv ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="000"
                        maxLength={4}
                      />
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.enderecoCobranca ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                      placeholder="Rua, número, complemento"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                        errors.cidadeCobranca ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                      }`}
                      placeholder="Cidade"
                    />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.estadoCobranca ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="SP"
                        maxLength={2}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full p-3 bg-slate-800 border rounded-lg text-white focus:outline-none transition-colors ${
                          errors.cepCobranca ? 'border-red-500 focus:border-red-400' : 'border-slate-600 focus:border-emerald-400'
                        }`}
                        placeholder="00000-000"
                        maxLength={9}
                      />
